...
const Contact = () => {
  ...
  const sendMessage = (e) => {
    e.preventDefault();
    axios.post('https://us-central1-portfolio-cd117.cloudfunctions.net/app/email', {
      name: name,
      email: email,
      message: message
    })
  ...
  const createNotification = () => {
    NotificationManager.success("Thanks for reaching out. I'll get back to you soon.", "Email sent successfully!");
  }
  return (
    <Fade duration="2000">
