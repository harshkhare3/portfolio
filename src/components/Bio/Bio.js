        ...
        <div className="bio__about">
          <div className="bio__image">
            ...
            <div className="bio__social">
              <FaGithub
                onClick={() =>
                  window.open("https://github.com/harshkhare3", "_blank")
                }
              ...
              <FaLinkedin
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/harsh-khare-a150b6180/",
                    "_blank"
                  )
                }
                className="bio__socialIcons"
              ...
              <FaTwitter
                onClick={() =>
                  window.open("https://twitter.com/JoninHK", "_blank")
                }
                className="bio__socialIcons"
                color="#1DA1F2"
              />
          ...
          <div className="bio__content">
            <h4>
              My name is <span style={{ color: "#01BF71" }}>Harsh Khare</span>
            </h4>
            ...
            <p>
              ...
              Adelaide <br />
              currently persuing CyberSecurity as major. I am a Full-Stack
              developer with <br />
              experience in web and app development.
              <br /> <br />I am also proficient in Object Oriented Programming
              (C++) and <br />
